		...
		<div class="row">
			...
			<div class="col-md-12 ">
				...
				<div style="border:thin solid #e5e5e5; padding:0px 8px 8px 8px;  border-radius: 20px; background-color:#ebebe4;">
					...
					<div class="row " style="padding: 0 0.5em 0.5 em 0.5em;" align="center">
						<h2 class="bg-primary input-lg" style="width:99%; padding:15px 0px 5px 0px; border-top-left-radius: 20px; border-bottom-left-radius: 0px; border-bottom-right-radius: 0px; border-top-right-radius: 20px;margin-top:0px; background-color:#575ca9; ">Add Administrator</h2>
					</div>
			<form  action="process/pro_edit.php" id="validation" name="myForm" method="post" enctype="multipart/form-data"> 
				...
				<div class="form-inline form-group ">
					...
					<select class="form-control input-lg " name="gender" style="margin-left:3%; margin-right:13.5%;" required>
					...
					<label>Status</label>
					<select class="form-control input-lg" name="stat" style="margin-left:3.5%; margin-right:13%;"  required>
				...
				<input type="hidden" name="num" value="<?=getMemberInfo($id,'mem_id')?>">
				...
				<div class="form-group">
					...
					<input type="date" name="dateofbirth" class="form-control input-lg" style="width:65.50%;" value="required></label>
				</div>
				...
				<div class="form-group">
					...
					<input type="text" name="user" class="form-control input-lg" style="width:65.50%;" required></label>
				</div>
				
				<div class="form-group">
					<span><label>Password:</label></span>
					<input type="text" name="pass" class="form-control input-lg" style="width:65.50%;" required></label>
				</div>
						
				<div class="form-group">
					<br/>
					<br/>
					<input type="submit" name="admin" style="width:25%;" class="btn btn-primary btn-lg btn-block" value="Save">
				</div>
				<script>

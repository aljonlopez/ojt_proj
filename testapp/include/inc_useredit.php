			...
			<div class="col-md-12 ">
				...
				<div style="border:thin solid #e5e5e5; padding:0px 8px 8px 8px;  border-radius: 20px; background-color:#ebebe4;">
					...
					<div class="row " style="padding: 0 0.5em 0.5 em 0.5em;" align="center">
						<h2 class="bg-primary input-lg" style="width:99%; padding:15px 0px 5px 0px; border-top-left-radius: 20px; border-bottom-left-radius: 0px; border-bottom-right-radius: 0px; border-top-right-radius: 20px;margin-top:0px; background-color:#575ca9; ">Edit aInformation</h2>
					</div>
			<form  action="process/pro_edituser.php" id="validation" name="myForm" method="post" enctype="multipart/form-data"> 
				<div class="form-inline form-group">
					<label>Last Name</label>
					<input type="text" name="lname" class="form-control input-lg" id="lname" style="margin-left:1%; margin-right:1%;" value="<?=getMemberInfo($id,'mem_lname')?>"required>
				...
				<img name="image" id="output" src="testapp/assets/images/<?=getMemberInfo($id,'mem_imagename')?>"  style="max-width: 160px; max-height: 120px; margin-right:90px;"/>

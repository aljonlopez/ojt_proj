...
<div class="header_btm">
	<div class="wrap">
		<div class="header_sub">
			<div class="h_menu">
				<ul>
					<li class="<?=isset($active1)?$active1:''?>"><a href="?con=list" >Users</a> </li>| 
					<li class="<?=isset($active2)?$active2:''?>"><a href="?con=pay" >Loans</a></li>|
					<li class="<?=isset($active3)?$active3:''?>"><a href="?con=depo" >Payments</a></li> |
					...
					<li class="<?=isset($active8)?$active8:''?>"><a href="?con=sellapproval" >Request Post</a></li> |
